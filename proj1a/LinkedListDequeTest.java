...
public class LinkedListDequeTest {
    ...
    public static void getTest() {
        ...
        passed = checkEqual("front", lld1.getRecursive(0)) && passed;
        passed = checkEqual("middle", lld1.getRecursive(1)) && passed;
        passed = checkEqual("back", lld1.getRecursive(2)) && passed;
        printTestStatus(passed);
    }
